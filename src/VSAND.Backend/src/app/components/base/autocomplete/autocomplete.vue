<template>
    <div class="autocomplete">
        <div class="autocomplete__box" :class="{'autocomplete__searching' : showResults}">
            ...
            <span v-show="!isLoading" class="autocomplete__icon fas fa-search"></span>
            <span v-show="isLoading" class="autocomplete__icon animate-spin fas fa-spinner"></span>
        ...
        <ul v-show="showResults" class="autocomplete__results" :style="listStyle">
            <slot name="results">
                ...
                <!-- no results -->
                <li v-if="showNoResults && noResults" class="autocomplete__results__item autocomplete__no-results" @click.prevent="noResultsSelect">
    ...
    export default {
        ...
        methods: {
            ...
            */
            request(url) {
                ...
                return $.ajax({
                    ...
                    .done(function (data) {
                        self.error = null;
                        self.results = self.setResults(data);
                        self.emitRequestResultEvent();
                        self.loading = false;
                    })
                    .fail(function () {
                        self.error = 'Network response was not ok.';
                        self.loading = false;
                    });
            },
            ...
            */
            ...
            /**
             * No Results item was selected
             * @param None
             */
            noResultsSelect() {
                this.$emit('noresultsclick', this.display);
            },
